...
public class Jshs {
    ...
    public Jshs() throws UnknownHostException {
    }



    @RequestMapping(value = "/deployx", method = RequestMethod.POST)
    @ResponseBody
...
//        Getting data from the mist file
    ...
    public String deployToNodeTwo(@RequestBody NodeTwo node) throws ClientProtocolException, IOException{
        if (node.url != null) {
